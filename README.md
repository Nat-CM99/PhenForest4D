...
Code related to the methodology developed in the Forest Engineering Final Course Work (UFPR) entitled "Investigação do potencial da aplicação de sensores LiDAR e espectrais para avaliação automatizada de experimentos de melhoramento genético de *Eucalyptus* spp.".
